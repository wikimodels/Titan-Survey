      ...
      },
      {
        question_answers: [
          ...
          },
          {
            answer_boolean_reply: false,
            answer_id: 1,
            answer_text: 'Довольно хорошо',
            answer_chart_text: 'Довольно хорошо',
            answer_clicked_style: 'initial',
          },
          {
            answer_boolean_reply: false,
            answer_id: 2,
            answer_text: 'Знаю не очень много',
          ...
          },
          {
            answer_boolean_reply: false,
            answer_id: 3,
            answer_text: 'Практически не разбираюсь',
        ...
        question_id: 15,
        question_text:
          'Насколько Вы хорошо разбираетесь в питании для поддержании здоровья позвоночника и суставов?',
        question_type: QuestionType.BUTTON_SINGLE_ANSWER,
        questions_total_number: 19,
      ...
      },
      {
        question_answers: [
          ...
          },
          {
            answer_boolean_reply: false,
            answer_id: 2,
            answer_text: 'Ароматерапия (лечение ароматами)',
